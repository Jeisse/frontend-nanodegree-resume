...
function setOnlineCourses(place){
...
setSchools(".education-entry");

$("#education").append(HTMLonlineClasses);
$("#education").append(HTMLschoolStart);
setOnlineCourses(".education-entry:last");
